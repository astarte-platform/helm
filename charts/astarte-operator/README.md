...
![Version: 24.5.2-rc.0](https://img.shields.io/badge/Version-24.5.2--rc.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 24.5.2-rc.0](https://img.shields.io/badge/AppVersion-24.5.2--rc.0-informational?style=flat-square)
...
| image.tag | string | `"24.5.2-rc.0"` | Overrides the image tag whose default is the chart appVersion. |
