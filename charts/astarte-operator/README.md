...
![Version: 23.5.0](https://img.shields.io/badge/Version-23.5.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 23.5.0](https://img.shields.io/badge/AppVersion-23.5.0-informational?style=flat-square)
...
| image.tag | string | `"23.5.0"` | Overrides the image tag whose default is the chart appVersion. |
